...
<Text style={styles.textViewContainer3} >{'Customer Information '}</Text>
...
<Text style={styles.textViewContainer3} >{'_____________________'}</Text>
<Text style={styles.textViewContainer3} >{'Requist Information '}</Text>
<Text style={styles.textViewContainer3} >{''}</Text>
...
<Text style={styles.textViewContainer3} >{'_____________________'}</Text>
<Text style={styles.textViewContainer3} >{'Vehicle Information '}</Text>
<Text style={styles.textViewContainer3} >{''}</Text>
<Text style={styles.textViewContainer} >{'Registration Number  : ' + item.RegistrationNumber}</Text>
